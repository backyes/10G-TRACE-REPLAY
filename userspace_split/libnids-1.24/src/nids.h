...
/*memory header and file header are not same, so define it*/
...
#define SPLIT_FILE_NUM 	8 
extern FILE *split_file[SPLIT_FILE_NUM];
extern unsigned int TCP_file_idx;
extern unsigned int UTCP_file_idx;

extern unsigned long cur_seq;
extern unsigned int  store_flag;
extern unsigned long tot_filter_nr;
